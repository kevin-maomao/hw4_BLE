...
#include "ble/services/MagnetoService.h"
...
const static char DEVICE_NAME[] = "Kevin's Sensor";
...
public:
    HeartrateDemo(BLE &ble, events::EventQueue &event_queue) :
        ...
        _magnetosensor_service(ble, pDataXYZ),
...
private:
    ...
    void update_sensor_value()
    {
        ...
        _magnetosensor_service.updateSensorRate(pDataXYZ);
    }
...
private:
    ...
    MagnetoSensorService _magnetosensor_service;
